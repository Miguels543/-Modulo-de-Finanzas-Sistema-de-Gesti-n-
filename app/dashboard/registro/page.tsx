...
export default function RegistroPage() {
  ...
  const [tipoRegistro, setTipoRegistro] = useState<string>("cliente")
  ...
  return (
    <div className="container py-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Ingrese los datos para crear un nuevo registro en el sistema</p>
      </div>

      <Card className="max-w-4xl mx-auto">
        <CardHeader>
          <CardTitle>Formulario de Registro</CardTitle>
          <CardDescription>Seleccione el tipo de registro y complete los campos requeridos</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex justify-end gap-4">
                <Button type="button" variant="outline" onClick={() => handleTipoChange(tipoRegistro)}>
                  Limpiar
                </Button>
        ...
        <CardFooter className="flex justify-between text-sm text-muted-foreground">
          ...
          <p>Los datos se guardarán en el sistema</p>
        </CardFooter>
      </Card>
    </div>
  )
